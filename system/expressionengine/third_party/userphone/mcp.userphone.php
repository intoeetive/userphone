...
class Userphone_mcp {
    ...
    function settings()
    {
    	...
    	$gateways = array(
			...
			//'textmagic'		=> lang('textmagic')
		);
		
		$member_groups = array();
		$member_groups[0] = lang('do_not_move');
        ...
        $vars['settings'] = array(	
            'move_to_group'	=> form_dropdown('move_to_group', $member_groups, $settings['move_to_group']),
            ...
            'sms_tmpl'	=> form_textarea('sms_tmpl', $settings['sms_tmpl'])
    		);
...
$(document).ready(function() {
    ...
    function save_settings()
    {
        ...
        $this->EE->functions->redirect(BASE.AMP.'C=addons_modules'.AMP.'M=show_module_cp'.AMP.'module=userphone'.AMP.'method=settings');
    }
